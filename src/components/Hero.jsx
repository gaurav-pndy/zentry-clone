...
const Hero = () => {
  ...
  useGSAP(() => {
    gsap.set("#video-frame", {
      clipPath: "polygon(23% 0, 67% 0, 87% 91%, 3% 84%)",
  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden">
      ...
      >
        <div>
          <div className="mask-clip-path-hero absolute-center absolute z-50 size-64 cursor-pointer overflow-hidden rounded-lg">
            <div
        ...
        <div className="absolute left-0 top-0 z-40 size-full">
          <div className="mt-24 px-5 sm:px-10">
            ...
            <p className="mb-5 maxw64 font-robert-regular text-blue-100">
